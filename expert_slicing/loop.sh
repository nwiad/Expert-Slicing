...
# echo "Looping for W2 E2 TP2" >> res/results.txt
# for i in "${sizes[@]}"
# do
#     > bin/sliced.txt
#     > bin/unsliced.txt
...
# echo "Looping for W2 E4 TP2" >> res/results.txt
# for i in "${sizes[@]}"
# do
#     > bin/sliced.txt
#     > bin/unsliced.txt
...
echo "Looping for W4 E4 TP2" >> res/results.txt
for i in "${sizes[@]}"
do
    > bin/sliced.txt
    > bin/unsliced.txt
...
echo "Looping for W4 E4 TP4" >> res/results.txt
for i in "${sizes[@]}"
do
    > bin/sliced.txt
    > bin/unsliced.txt
...
# echo "Looping for W4 E4 TP4 step100" >> res/results.txt
