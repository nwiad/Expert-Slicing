...
class SentimentClassificationMoE(nn.Module):
    def __init__(self, vocab_size, embedding, embedding_dim, expert, hidden_size, experts_num, device_ids, output_dim):
        """
        ...
        self.moe_layer = MoE(hidden_size=hidden_size, expert=expert, ep_size=experts_num, num_experts=experts_num)
